...
banner() {
    ...
    echo -e "\e[1;32m           Instagram https://www.instagram.com/mr.adi_op \e[0m"
    echo -e "\e[4;32m   Telegram https://t.me/hackgodstore \e[0m"
    echo " "
    echo "AMITACHARYA KE SUSHEEL BACCHE. x HACKGOD ADI"
    echo " "
}
